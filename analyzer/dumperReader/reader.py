...
class DumperReader:
    ...
    def simCandidates(self) -> ak.Array:
        return self.fileDir["simTICLCandidate"].arrays(filter_name=["simTICLCandidate_raw_energy",
            "simTICLCandidate_regressed_energy","simTICLCandidate_time","simTICLCandidate_track_in_candidate"])
    ...
    def associations(self) -> ak.Array:
        return self.fileDir["associations"].arrays(filter_name=["ticlCandidate_simToReco_CP","ticlCandidate_simToReco_CP_sharedE","ticlCandidate_simToReco_CP_score"])#["event_", "tsCLUE3D_*", 'ticlCandidate_*', 'Mergetracksters_*'])
